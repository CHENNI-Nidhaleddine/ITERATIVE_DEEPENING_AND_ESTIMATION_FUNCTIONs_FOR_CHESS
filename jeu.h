...
/* ----------------------------------
 ...
 (donc avoir une indication sur la stabilité de la configuration couante: conf)
*/
int minmax_ab(struct config* conf, int mode, int niv, int min, int max, int largeur, int numFctEst, int npp);
